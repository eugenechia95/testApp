...
// console.log("main",  main.getSizes().width,  main.getSizes().height,  main.getSizes().realZoom)
        ...
        var _updateMainViewPan = function(clientX, clientY, scopeContainer, main, thumb){
            ...
            var thumbPanX = clientX - dim.left - (mainWidth*thumbZoom/mainZoom-2)/2 -thumb.getPan().x;
            var thumbPanY = clientY - dim.top - (mainHeight*thumbZoom/mainZoom-2)/2 - thumb.getPan().y;
    ...
    //mainViewObjectElem.addEventListener("load", function(){ //load
    //window.addEventListener("load", function(){
console.log("mainView", options.mainViewId)
